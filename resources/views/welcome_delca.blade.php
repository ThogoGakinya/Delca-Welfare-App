...
<head><meta http-equiv="Content-Type" content="text/html; charset=utf-8">
    ...
    <title>Delca Welfare - Deliverance Church Intenational</title>
    <!-- Custom CSS -->
...
<body style="background-image: url('{{ asset('assets/images/bac.png')}}');">
    <div class="main-wrapper">
        ...
        <div class="auth-wrapper d-flex no-block justify-content-center align-items-center">
            <div class="auth-box bg-light border-secondary" style="border-radius: 5%;">
                <div id="loginform">
                    <div class="text-center p-t-20 p-b-20">
                        <span class="db"><img src="{{ asset('assets/images/delca_landing_logo.png')}}" alt="logo" /></span>
                    </div>
                    <!-- Form -->
                ...
                <div id="recoverform">
                    <div class="text-center">
                        <span class="text-white">Enter your e-mail address below and we will send you instructions how to recover your password.</span>
                    </div>
